...
const ITEMS = [
  { id: 1, emoji: '✏️', name: 'Pencil Set', nameHi: 'पेंसिल सेट', desc: '12 coloured pencils', price: 60, color: 'from-yellow-400 to-amber-500' },
  { id: 2, emoji: '📓', name: 'Notebook', nameHi: 'नोटबुक', desc: 'A4 ruled, 200 pages', price: 80, color: 'from-blue-400 to-indigo-500' },
  { id: 3, emoji: '🖊️', name: 'Pen Pack', nameHi: 'पेन पैक', desc: 'Blue, black & red pens', price: 45, color: 'from-sky-400 to-cyan-500' },
  { id: 4, emoji: '📐', name: 'Geometry Box', nameHi: 'ज्योमेट्री बॉक्स', desc: 'Complete math set', price: 120, color: 'from-purple-400 to-violet-600' },
  { id: 5, emoji: '🎨', name: 'Colour Box', nameHi: 'कलर बॉक्स', desc: '24 wax crayons', price: 75, color: 'from-pink-400 to-rose-500' },
  { id: 6, emoji: '📏', name: 'Scale & Eraser', nameHi: 'स्केल और रबड़', desc: '30cm ruler + eraser', price: 30, color: 'from-orange-400 to-red-500' },
  { id: 7, emoji: '✂️', name: 'Scissors', nameHi: 'कैंची', desc: 'Safe round-tip', price: 55, color: 'from-teal-400 to-emerald-500' },
  { id: 8, emoji: '🗂️', name: 'Folder Set', nameHi: 'फोल्डर सेट', desc: 'Pack of 5 coloured', price: 90, color: 'from-fuchsia-400 to-pink-600' },
]
...
function StationeryGame() {
  ...
  const buildLink = () => {
    ...
    const text = encodeURIComponent(
      `नमस्ते! मैं यह किट ऑर्डर करना चाहता/चाहती हूं:\n\n${list}\n\nकुल: ₹${total}\n\nHi! I'd like to order this kit:\n${list}\nTotal: ₹${total}`
    )
    ...
    <section className="py-20 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-primary-400 font-devanagari mt-1 text-base">अपना स्कूल किट बनाएं!</p>
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          <div className="glass-light rounded-2xl px-6 py-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-primary-400 text-xs font-devanagari">{selected.length} आइटम चुने</p>
            </div>
          </div>
          {selected.length > 0 && (
            <div className="glass-light rounded-2xl px-6 py-3 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-primary-400 text-xs font-devanagari">कुल मूल्य</p>
              </div>
            </div>
          )}
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className={`text-xs mt-0.5 font-devanagari ${isSelected ? 'text-white/80' : 'text-primary-400'}`}>{item.nameHi}</p>
