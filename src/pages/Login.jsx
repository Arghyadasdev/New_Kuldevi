      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass rounded-3xl overflow-hidden shadow-2xl border border-white/10">
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              <div className="relative inline-block mb-5">
                ...
                <div className="relative w-18 h-18 bg-gradient-to-br from-gold-500 to-primary-700 rounded-2xl flex items-center justify-center text-white font-bold text-3xl shadow-xl font-devanagari px-5 py-4">
                  क
                </div>
              </div>
              <h1 className="text-2xl font-display font-bold text-white mb-1">{t('adminLoginTitle')}</h1>
              <p className="text-primary-300 text-sm font-devanagari">कुलदेवी स्टेशनरी · बेंगलुरु</p>
            </div>
          ...
          <div className="px-8 py-4 text-center">
            <p className="text-primary-500 text-xs">🔒 Admin access only · कुलदेवी स्टेशनरी</p>
          </div>
        </div>
      </div>
    </div>
