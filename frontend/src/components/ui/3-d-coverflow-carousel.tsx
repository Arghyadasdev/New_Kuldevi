...
export const defaultShowcaseItems: CarouselItem[] = [
  {
    tag: "#Pens",
    titleLine1: "PREMIUM FOUNTAIN PENS",
    titleLine2: "– TIMELESS WRITING",
    desc: "Smooth-flowing nibs and balanced weight, crafted for everyday elegance",
    img: "https://images.unsplash.com/photo-1531346878377-a5be20888e57?w=900&q=80&auto=format&fit=crop",
    ctaText: "Shop Pens",
    ctaUrl: "/products?category=pens",
  },
  {
    tag: "#Notebooks",
    titleLine1: "ARTISAN NOTEBOOKS",
    titleLine2: "– RULED & UNRULED",
    desc: "Premium paper stock bound for journaling, planning and everyday notes",
    img: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=900&q=80&auto=format&fit=crop",
    ctaText: "Shop Notebooks",
    ctaUrl: "/products?category=notebooks",
  },
  {
    tag: "#ArtSupplies",
    titleLine1: "ART & COLOUR",
    titleLine2: "– FOR EVERY CREATION",
    desc: "Vivid paints, pencils and brushes for students and artists alike",
    img: "https://images.unsplash.com/photo-1568205612837-017257d2310a?w=900&q=80&auto=format&fit=crop",
    ctaText: "Shop Art Supplies",
    ctaUrl: "/products?category=art-supplies",
  },
  {
    tag: "#OfficeSupplies",
    titleLine1: "OFFICE ESSENTIALS",
    titleLine2: "– STAY ORGANIZED",
    desc: "Everything your desk needs, from files to staplers to sticky notes",
    ...
    ctaUrl: "/products?category=office-supplies",
  },
  {
    tag: "#DeskAccessories",
    titleLine1: "DESK & WORKSPACE",
    titleLine2: "– ORGANIZE IN STYLE",
    desc: "Curated desk accessories that make your workspace a pleasure to sit at",
    img: "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=900&q=80&auto=format&fit=crop",
    ctaText: "Shop Desk Accessories",
    ctaUrl: "/products?category=desk-accessories",
  },
];
