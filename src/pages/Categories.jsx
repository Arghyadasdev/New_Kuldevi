...
const CATEGORY_DATA = {
  'pens':             { icon: '🖊️', color: 'from-blue-500 to-indigo-600',   desc: 'Premium writing instruments',   hi: 'लिखने के साधन' },
  'notebooks':        { icon: '📓', color: 'from-emerald-500 to-teal-600',  desc: 'Journals, planners & ruled',     hi: 'नोटबुक व डायरी' },
  'art-supplies':     { icon: '🎨', color: 'from-purple-500 to-violet-600', desc: 'Colors for every creation',      hi: 'रंग व कला सामग्री' },
  'office-supplies':  { icon: '📎', color: 'from-orange-500 to-red-500',    desc: 'Essentials for productivity',    hi: 'ऑफिस सामग्री' },
  'paper-products':   { icon: '📄', color: 'from-slate-500 to-gray-600',    desc: 'Quality paper & cards',          hi: 'कागज़ उत्पाद' },
  'desk-accessories': { icon: '✏️', color: 'from-teal-500 to-cyan-600',     desc: 'Organize your workspace',        hi: 'डेस्क सामग्री' },
}
...
function getInfo(name) {
  ...
  return CATEGORY_DATA[slug] || { icon: '📦', color: 'from-primary-500 to-primary-700', desc: 'Explore our collection', hi: 'संग्रह देखें' }
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="relative mesh-bg py-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-primary-200 font-devanagari text-base">श्रेणी के अनुसार खरीदें</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-primary-300 text-xs font-devanagari">{info.hi}</p>
