        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-gold-500 rounded-full flex items-center justify-center text-primary-950 font-bold text-2xl shadow-lg">
                क
              </div>
              <div>
                <span className="text-xl font-display font-bold">KULDEVI</span>
                <span className="text-gold-400 text-xs block font-devanagari">कुलदेवी स्टेशनरी</span>
              </div>
            </div>
            <p className="text-primary-300 text-sm leading-relaxed mb-2">
              Your trusted stationery destination since 1995.
            </p>
            <p className="text-gold-400 text-sm font-devanagari mb-6">
              १९९५ से बेंगलुरु की भरोसेमंद स्टेशनरी दुकान।
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/categories/pens" className="text-primary-300 hover:text-gold-400 transition-colors text-sm">Pens / पेन</Link></li>
              <li><Link to="/categories/notebooks" className="text-primary-300 hover:text-gold-400 transition-colors text-sm">Notebooks / नोटबुक</Link></li>
              <li><Link to="/categories/art-supplies" className="text-primary-300 hover:text-gold-400 transition-colors text-sm">Art Supplies / कला सामग्री</Link></li>
              <li><Link to="/categories/office-supplies" className="text-primary-300 hover:text-gold-400 transition-colors text-sm">Office Supplies / ऑफिस सामग्री</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3 text-primary-300">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm">
                  ...
                  <span className="font-devanagari text-xs text-gold-400">बेंगलुरु, कर्नाटक - 560001</span><br />
      ...
      <div className="border-t border-primary-800">
        <div className="container mx-auto px-4 py-5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            ...
            <p className="text-primary-500 text-xs font-devanagari">
              🇮🇳 भारत में बना · Made in India
            </p>
          </div>
        </div>
      </div>
